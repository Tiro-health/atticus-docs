...
<Properties>
  ...
  <Property
    name="identifier"
    type="Identifier[]"
    href="https://hl7.org/fhir/R5/encounter-definitions.html#Encounter.identifier"
  >
    An array of
    [`Identifier`](https://hl7.org/fhir/R5/datatypes.html#identifier) objects
    for this Encounter (e.g. MRN, SSN). This is the place to store EHR
    identifiers or hospital identifiers for the patient. More information about
    identifiers in Atticus can be found
  ...
  <Property
    ...
    type="Reference"
    required
    href="https://hl7.org/fhir/R5/encounter-definitions.html#Encounter.subject"
  >
    A FHIR

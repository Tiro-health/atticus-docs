export const metadata = {
  ...
  description:
    'On this page, we’ll dive into the different QuestionnaireResponse endpoints you can use to manage responses programmatically.',
}
...
<Properties>
  ...
  <Property name='identifier' type='Identifier[]' href='https://hl7.org/fhir/R5/questionnaireresponse-definitions.html#QuestionnaireResponse.identifier'>
      ...
      More information about identifiers in Atticus can be found [here](./tips#store-your-internal-identifiers-in-fhir-resources).
  </Property>

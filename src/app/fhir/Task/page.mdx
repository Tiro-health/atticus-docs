export const metadata = {
  title: 'Task',
  description:
    'On this page, we will dive into the different Task endpoints you can use to manage tasks programmatically.',
}
...
| **Composition**          | References a resource extracted from the completed form — the report [Composition](https://hl7.org/fhir/R5/Composition), and any `Observation` or other resource the template extracts | [Reference](https://hl7.org/fhir/R5/references.html#reference) to the extracted resource                                                | `composition`            |
...
**Prerequesities**: This request requires a Patient resource for the subject to be present in the server.

...
5. **Web-based EHRs and LISs**: Tiro.health supports integration with any web-based EHR or LIS system that can launch external URLs. This includes systems like Epic, Cerner, and others. [Learn more](./context) about context launches and how to set up the integration.
...
### Context Launch
To provide a seamless user experience between your system and Atticus, we support contextual launches that allow users to access patient-specific information directly. Tiro.health supports two authentication patterns:
...
The submission process follows three distinct steps:
   ...
   1. **User clicks submit**: The user completes their work in Atticus and clicks the submit button.

...
Below is an example of a FHIR transaction bundle that imports a patient with an identifier and creates a "complete-questionnaire" task. This task references the patient and includes a questionnaire input parameter.

...
export const sections = [
  ...
  { title: 'Get Session Information', id: 'get-session' },
  { title: 'Delete a Session', id: 'delete-session' },
  { title: 'Scope-based Access Control', id: 'scope-access-control' },
  { title: 'FHIR Context', id: 'fhir-context' },
  { title: 'Security Considerations', id: 'security' },
]

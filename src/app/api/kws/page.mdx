...
3. Once your data tenant is setup, Tiro.health will invite your hospital's system administrators by email. This email wil contain instructions and credentials for your hospital's Tiro.health data tenant.
...
{/**### Setting Up SSL Manager

For secure communications between Mirth and external systems (including KWS and Tiro.health), you need to configure the SSL Manager in Mirth:

1. Navigate to **Settings** > **System Settings** in the Mirth Connect Administrator.
2. Select the **SSL Manager** tab.
3. Configure the following:
   - **Keystore**: Upload your organization's keystore file (.jks)
   - **Keystore Password**: Enter the password for your keystore
   - **Key Password**: Enter the password for the private key
   - **Trust Stores**: Add any necessary trust stores for external certificates
4. Click **Save Changes** to apply the SSL configuration.

Make sure your SSL certificates are valid and trusted by all systems in the integration chain.
*/}

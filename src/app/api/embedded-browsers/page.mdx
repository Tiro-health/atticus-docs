...
The `next` parameter carries the [Launch URL](/api/session-management#session-handover) — the task to open once the session is active. Both parameters must be URL-encoded.

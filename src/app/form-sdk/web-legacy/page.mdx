...
<Note>
  This is the legacy SDK documentation using the imperative `mount()`/`unmount()` API. For the recommended approach using native Web Components, see the [Web SDK documentation](/form-sdk/web).
</Note>
...
For detailed API documentation, see [FormFiller API Reference](/form-sdk/web/api/form-filler).
...
For detailed API documentation, see [LaunchContextProvider API Reference](/form-sdk/web/api/launch-context-provider).
...
For detailed API documentation, see [Narrative API Reference](/form-sdk/web/api/narrative).
...
For detailed API documentation, see [ValidationFeedback API Reference](/form-sdk/web/api/validation-feedback).
...
For detailed configuration options, see [SDCClient API Reference](/form-sdk/web/api/sdc-client).

...
After configuring your npm environment, you can quickly integrate the Web UI SDK into your application.
...
Choose your framework and follow our comprehensive integration guides:

- **[React Integration](/form-sdk/web/integration/react)** - Hooks, refs, and proper cleanup patterns
- **[Angular Integration](/form-sdk/web/integration/angular)** - Lifecycle hooks, ViewChild, and standalone components
- **[Vanilla JS Integration](/form-sdk/web/integration/vanilla-js)** - ES modules with Vite
- **[CDN Integration](/form-sdk/web/integration/cdn)** - Quick prototyping without build tools

### API Documentation

Explore the complete API reference:

- **[FormFiller](/form-sdk/web/api/form-filler)** - Main form component
- **[LaunchContextProvider](/form-sdk/web/api/launch-context-provider)** - Patient context integration
- **[Narrative](/form-sdk/web/api/narrative)** - Clinical narrative generation
- **[ValidationFeedback](/form-sdk/web/api/validation-feedback)** - Real-time validation display

For complete Web SDK documentation, see the [Web UI SDK overview](/form-sdk/web).

export const metadata = {
  title: 'Patient',
  description:
    'On this page, we’ll dive into the different Patient endpoints you can use to manage patients programmatically.',
}

# Patient

As the name suggests, patients are a core part of Atticus. On this page, we'll dive into the different Patient endpoints you can use to manage patients programmatically. We'll look at how to query, create, update, and delete contacts. {{ className: 'lead' }}

## The Patient model

The Patient model contains all the information about your contacts, such as their username, avatar, and phone number. It also contains a reference to the conversation between you and the contact and information about when they were last active on Protocol.
...
<Row>
  ...
  <Col sticky>
    ...
    var response = client.Update<Patient>(subject);
    ```
    </CodeGroup>
